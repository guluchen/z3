...
(assert (not (str.contains annotations "E__F")))
...
(assert (not (str.contains annotations "E__F__D")))
...
(assert (not (str.contains annotations "E__F__D__A")))
...
(assert (not (str.contains annotations "E__F__D__A__C")))
...
(assert (< 6 (str.len (str.substr lookup_parts 0 (- 6 0)))))
(check-sat)
