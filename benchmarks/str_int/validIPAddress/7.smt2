...
(assert ( str.contains IP "."  ))(assert ( > ( str.to.int ( str.substr ( str.substr IP ( + ( str.indexof IP "." 0  ) 1  ) ( + ( - ( str.len IP  ) ( + ( str.indexof IP "." 0  ) 1  )  ) 1  )  ) 0 ( + ( - ( str.indexof ( str.substr IP ( + ( str.indexof IP "." 0  ) 1  ) ( + ( - ( str.len IP  ) ( + ( str.indexof IP "." 0  ) 1  )  ) 1  )  ) "." 0  ) 0  ) 1  )  )  ) 255  ))
