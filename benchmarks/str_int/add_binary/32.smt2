...
(assert (not ( >= ( - ( + ( + ( + 0 1  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 4)  )  )  )  ) ( str.to.int ( str.at b ( + ( str.len b  ) (- 4)  )  )  )  ) 2  ) 2  )))

(assert ( >= ( + ( + ( + 0 1  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 4)  )  )  )  ) ( str.to.int ( str.at b ( + ( str.len b  ) (- 4)  )  )  )  ) 2  ))
