...
(assert ( >= ( + ( str.len a  ) (- 1)  ) 0  ))(assert ( >= ( - ( + ( + ( + 0 1  ) ( str.to.int ( str.at a ( + ( str.len a  ) (- 4)  )  )  )  ) ( str.to.int ( str.at b ( + ( str.len b  ) (- 4)  )  )  )  ) 2  ) 2  ))(assert (str.in.re a (re.+ (re.range "0" "1"))))(assert (str.in.re b (re.+ (re.range "0" "1"))))
