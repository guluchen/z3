...
(assert ( >= ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 3)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  )  ) 1  ) 10  ))(assert (str.in.re num1 (re.+ (re.range "0" "9"))))(assert (str.in.re num2 (re.+ (re.range "0" "9"))))
