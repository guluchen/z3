...
(assert ( > ( str.len ( str.++ ( str.++ "" ( int.to.str ( + ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) 0  )  )  ) ( int.to.str ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 1)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  )  ) 0  )  )  )  ) ( ite ( > ( str.len num1  ) ( str.len num2  )  ) ( str.len num1  ) ( str.len num2  )  )  ))(assert (str.in.re num1 (re.+ (re.range "0" "9"))))(assert (str.in.re num2 (re.+ (re.range "0" "9"))))
