...
(assert ( not ( = ( div ( + ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) ( div ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 1)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  )  ) 0  ) 10  )  ) 10  ) 0  )  ))
