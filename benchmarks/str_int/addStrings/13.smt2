...
(assert (not ( >= ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 3)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 3)  )  )  )  ) 0  ) 10  )))
