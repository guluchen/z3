...
(assert (not ( >= ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 3)  )  )  ) 0  ) 10  )))

(assert ( >= ( + ( - ( - (- 1) 1  ) 1  ) ( str.len num1  )  ) 0  ))
(assert (not ( >= ( + ( - ( - (- 1) 1  ) 1  ) ( ite ( < ( str.len num1  ) ( str.len num2  )  ) ( str.len num1  ) ( str.len num2  )  )  ) 0  )))

(assert (not ( >= ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 2)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  )  ) 0  ) 10  )))
