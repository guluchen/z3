...
(assert (not ( >= ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 5)  )  )  ) 0  ) 10  )))

(assert ( >= ( + ( - ( - ( - ( - (- 1) 1  ) 1  ) 1  ) 1  ) ( str.len num1  )  ) 0  ))
(assert (not ( >= ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 4)  )  )  ) 1  ) 10  )))
