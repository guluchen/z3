...
(assert (not ( > ( str.len ( str.++ ( str.++ ( str.++ "" ( int.to.str 1  )  ) ( int.to.str ( - ( + ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 2)  )  )  ) 1  ) 10  )  )  ) ( int.to.str ( - ( + ( + ( str.to.int ( str.at num1 ( + ( str.len num1  ) (- 1)  )  )  ) ( str.to.int ( str.at num2 ( + ( str.len num2  ) (- 1)  )  )  )  ) 0  ) 10  )  )  )  ) ( ite ( > ( str.len num1  ) ( str.len num2  )  ) ( str.len num1  ) ( str.len num2  )  )  )))
