...
(assert ( = ( + 0 ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 1  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 2  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 3  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 4  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 5  )  )  )  ) ( div ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 6  )  )  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 0  ))
