...
(assert (not ( = num1 "0"  )))
(assert (not ( = ( + 0 ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 1  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 2  )  )  )  ) ( div ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 3  )  )  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 0  )))
