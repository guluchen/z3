...
(assert ( = ( + 0 ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 0  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 1  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 2  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + ( + 0 ( * ( str.to.int ( str.at num1 3  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) ( div ( + 0 ( * ( str.to.int ( str.at num1 4  )  ) ( str.to.int ( str.at num2 0  )  )  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 10  )  ) 0  ))
