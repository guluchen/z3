...
(assert ( < 0 ( str.len abbr  )  ))(assert ( not ( = ( str.at word 13  ) ( str.at abbr 3  )  )  ))(assert (str.in.re word (re.+ (re.range "a" "z"))))(assert (str.in.re abbr (re.+ (re.union (re.range "0" "9") (re.range "a" "z")))))
