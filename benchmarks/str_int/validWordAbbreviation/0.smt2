...
(assert (not ( not ( = ( str.at word 19  ) ( str.at abbr 6  )  )  )))
...
(assert ( < 0 ( str.len abbr  )  ))(assert (not ( = ( + ( + ( + ( + ( + ( + ( + ( + ( + 0 0  ) 1  ) ( + ( * ( + ( * 0 10  ) ( str.to.int ( str.at abbr 1  )  )  ) 10  ) ( str.to.int ( str.at abbr 2  )  )  )  ) 1  ) 0  ) 1  ) ( + ( * 0 10  ) ( str.to.int ( str.at abbr 5  )  )  )  ) 1  ) 0  ) ( str.len word  )  )))
