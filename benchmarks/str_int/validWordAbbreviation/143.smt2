...
(assert (not ( < ( + ( + ( + ( + ( + ( + ( + 0 1  ) 1  ) 1  ) 1  ) 1  ) 1  ) 1  ) ( str.len abbr  )  )))

(assert (not ( = ( str.to.int ( str.at abbr 6  )  ) 0  )))

(assert ( str.in.re ( str.at abbr 6  ) ( re.++ ( re.opt ( str.to.re "-"  )  ) ( re.+ ( re.range "0" "9"  )  )  )  ))
(assert ( < ( + ( + ( + ( + ( + ( + 0 1  ) 1  ) 1  ) 1  ) 1  ) 1  ) ( str.len abbr  )  ))
(assert (not ( = ( + ( * 0 10  ) ( str.to.int ( str.at abbr 4  )  )  ) 0  )))

(assert ( = ( str.to.int ( str.at abbr 5  )  ) 0  ))
(assert ( str.in.re ( str.at abbr 5  ) ( re.++ ( re.opt ( str.to.re "-"  )  ) ( re.+ ( re.range "0" "9"  )  )  )  ))
(assert ( < ( + ( + ( + ( + ( + 0 1  ) 1  ) 1  ) 1  ) 1  ) ( str.len abbr  )  ))
(assert (not ( = ( str.to.int ( str.at abbr 4  )  ) 0  )))

(assert ( str.in.re ( str.at abbr 4  ) ( re.++ ( re.opt ( str.to.re "-"  )  ) ( re.+ ( re.range "0" "9"  )  )  )  ))
...
(assert ( < 0 ( str.len abbr  )  ))(assert ( = ( + ( + ( + ( + ( + 0 0  ) 1  ) ( + ( * ( + ( * 0 10  ) ( str.to.int ( str.at abbr 1  )  )  ) 10  ) ( str.to.int ( str.at abbr 2  )  )  )  ) 1  ) ( + ( * ( + ( * ( + ( * 0 10  ) ( str.to.int ( str.at abbr 4  )  )  ) 10  ) ( str.to.int ( str.at abbr 5  )  )  ) 10  ) ( str.to.int ( str.at abbr 6  )  )  )  ) ( str.len word  )  ))(assert (str.in.re word (re.+ (re.range "a" "z"))))(assert (str.in.re abbr (re.+ (re.union (re.range "0" "9") (re.range "a" "z")))))
