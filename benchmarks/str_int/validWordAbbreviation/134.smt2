...
(assert (not ( str.in.re ( str.at abbr 7  ) ( re.++ ( re.opt ( str.to.re "-"  )  ) ( re.+ ( re.range "0" "9"  )  )  )  )))
...
(assert ( < 0 ( str.len abbr  )  ))(assert (not ( >= ( + ( + ( + ( + ( + ( + ( + 0 0  ) 1  ) ( + ( * ( + ( * 0 10  ) ( str.to.int ( str.at abbr 1  )  )  ) 10  ) ( str.to.int ( str.at abbr 2  )  )  )  ) 1  ) 0  ) 1  ) ( + ( * ( + ( * 0 10  ) ( str.to.int ( str.at abbr 5  )  )  ) 10  ) ( str.to.int ( str.at abbr 6  )  )  )  ) ( str.len word  )  )))
