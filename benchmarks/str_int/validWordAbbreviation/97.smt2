...
(assert ( < 0 ( str.len abbr  )  ))(assert ( = ( + ( * 0 10  ) ( str.to.int ( str.at abbr 4  )  )  ) 0  ))(assert (str.in.re word (re.+ (re.range "a" "z"))))(assert (str.in.re abbr (re.+ (re.union (re.range "0" "9") (re.range "a" "z")))))
