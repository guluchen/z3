...
(assert ( < 0 ( str.len abbr  )  ))(assert ( = ( + ( + ( + 0 0  ) 1  ) ( + ( * 0 10  ) ( str.to.int ( str.at abbr 1  )  )  )  ) ( str.len word  )  ))(assert (str.in.re word (re.+ (re.range "a" "z"))))(assert (str.in.re abbr (re.+ (re.union (re.range "0" "9") (re.range "a" "z")))))
