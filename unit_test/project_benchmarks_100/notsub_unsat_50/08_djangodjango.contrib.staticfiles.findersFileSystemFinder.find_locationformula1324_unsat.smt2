...
(assert (= (+ 0 (str.indexof (str.substr (str.++ "/root/py-conbyte" (str.++ "/" root)) (+ (+ 0 (str.indexof (str.++ "/root/py-conbyte" (str.++ "/" root)) "/" 0)) 1) (- (str.len (str.++ "/root/py-conbyte" (str.++ "/" root))) (+ (+ 0 (str.indexof (str.++ "/root/py-conbyte" (str.++ "/" root)) "/" 0)) 1))) "/" 0)) (- 1)))
(check-sat)
(get-value (root))
(get-value (path))
