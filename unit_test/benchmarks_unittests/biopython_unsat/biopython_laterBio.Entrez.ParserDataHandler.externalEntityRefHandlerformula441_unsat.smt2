...
(assert (not (< 6 (str.len (str.substr systemId 0 (- (+ 0 (str.indexof systemId ":" 0)) 0))))))
...
(assert (not (< 0 (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))))))
(check-sat)
(get-value (self))
(get-value (context))
(get-value (base))
