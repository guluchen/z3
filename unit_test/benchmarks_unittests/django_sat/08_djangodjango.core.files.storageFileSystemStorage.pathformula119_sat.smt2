...
(assert (= (str.substr (str.substr name (+ (+ 0 (str.indexof name "/" 0)) 1) (- (str.len name) (+ (+ 0 (str.indexof name "/" 0)) 1))) 0 (- (+ 0 (str.indexof (str.substr name (+ (+ 0 (str.indexof name "/" 0)) 1) (- (str.len name) (+ (+ 0 (str.indexof name "/" 0)) 1))) "/" 0)) 0)) "."))
(check-sat)
(get-value (name))
