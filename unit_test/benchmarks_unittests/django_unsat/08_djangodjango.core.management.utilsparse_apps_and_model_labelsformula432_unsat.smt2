...
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.shell")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.shortcuts")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.signals")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.signed_cookies_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.signing")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.sitemaps_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.sites_framework")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.sites_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.staticfiles_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.str")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.string_lookup")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.swappable_models")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.syndication_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.template_backends")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.template_loader")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.template_tests")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.templates")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_client")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_client_regress")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_exceptions")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_runner")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_runner_apps")))
(assert (not (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.test_utils")))
(assert (= (str.substr (str.at labels 0) 0 (- (+ 0 (str.indexof (str.at labels 0) "." 0)) 0)) "tests.timezones"))
(check-sat)
(get-value (labels))
