...
(assert (not (>= (+ 2 (str.indexof (str.substr (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1))) 2 (- (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))) 2)) "/" 0)) 0)))
(assert (not (< (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))) 0)))
(assert (not (>= (+ 2 (str.indexof (str.substr (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1))) 2 (- (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))) 2)) "?" 0)) 0)))
(assert (not (< (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))) 0)))
(assert (not (>= (+ 2 (str.indexof (str.substr (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1))) 2 (- (str.len (str.substr systemId (+ (+ 0 (str.indexof systemId ":" 0)) 1) (- (str.len systemId) (+ (+ 0 (str.indexof systemId ":" 0)) 1)))) 2)) "#" 0)) 0)))
